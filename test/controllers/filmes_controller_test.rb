...
class FilmesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create filme" do
    assert_difference('Filme.count') do
      post filmes_url, params: { filme: { classificacao: @filme.classificacao, nome: @filme.nome, nota: @filme.nota } }
    end
  ...
  test "should update filme" do
    patch filme_url(@filme), params: { filme: { classificacao: @filme.classificacao, nome: @filme.nome, nota: @filme.nota } }
